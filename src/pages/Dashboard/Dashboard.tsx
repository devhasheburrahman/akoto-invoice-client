...
import { Box, Button, Paper, TableContainer, Table, TableHead, TableCell, TableBody, } from '@mui/material'
    ...
    <Box >
      ...
      <Box className="grid grid-cols-4 gap-[33px]">
        <Box className="bg-[#50D27E] col-span-1 rounded-[10px]">
          <DashBoardCard date='Today sale' balance={100000} />
        </Box>
        ...
        <Box className='w-full'>
          <Paper className='  px-[22px] py-[20px]'>
            <Box className='flex justify-between'>
              <Box>
                ...
                <Box className='text-black font-bold text-[22px]'> <EventNoteIcon /> 30/100 </Box>
              </Box>
              <Box> <Button variant='outlined' color='success'> Free Trail</Button></Box>
            </Box>
            <LinearProgress sx={{
              height: 20,
              borderRadius: 5,
          ...
          <Paper>
            <Box className="w-full  mt-[44px] px-[22px] py-[25px]">
              <Box className="text-[18px] mb-[42px] font-semibold">Recent Invoices</Box>
              <TableContainer >
